          ...
          {projects.map((project, idx) => (
            ...
            >
              <div className="relative aspect-video overflow-hidden">
                ...
                />
                <span className="absolute top-3 left-3 px-2 py-1 text-xs font-mono bg-bg/80 backdrop-blur rounded">
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-1.5 mb-4">
                  {project.tech.slice(0, 3).map((t) => (
                    <span
                      key={t}
                      className="px-2 py-0.5 text-xs rounded bg-bg border border-border"
                    >
                      {t}
                    </span>
                  ))}
