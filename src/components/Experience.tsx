            ...
            >
              ...
              <div className="p-6 rounded-xl border border-border bg-card hover:border-accent/50 transition-colors">
                <div className="flex flex-wrap gap-2 mb-2">
                  <span className="text-xs uppercase tracking-wider text-accent">{exp.type}</span>
                ...
                <div className="flex flex-wrap gap-2">
                  {exp.tech.map((t) => (
                    <span key={t} className="px-2 py-1 text-xs rounded bg-bg border border-border">{t}</span>
                  ))}
                </div>
              </div>
            </motion.div>
